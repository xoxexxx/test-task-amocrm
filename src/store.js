...
export const useAppStore = create((set, get) => ({
    ...
    open_lead: [],
    setOpenLead: (id) => set({ open_lead: get().open_lead.indexOf(id) !== -1 ? [...get().open_lead.slice(0, get().open_lead.indexOf(id)), ...get().open_lead.slice(get().open_lead.indexOf(id) + 1)] : [...get().open_lead, id] }),
